...
const About = () => {
  return (
    ...
    <div className='relative space-y-10 min-h-screen px-6 md:px-12 py-32 z-0 bg-center  bg-no-repeat bg-fixed bg-[url("logo.webp")] bg-cover flex flex-col justify-center items-center overflow-auto'>
