...
const FileUploadForm = () => {
  ...
  const handleUpload = (name) => {
      ...
      fetch(`/.netlify/functions/getSignedUrl?fileName=${fileData[name].name}`, {
          method: "GET",
          headers: {
              "Authorization": localStorage.getItem('token'),
          },
  ...
  return (
      <form className="w-[1024px] flex flex-col bg-white pt-8 px-4">
          ...
          <div className="w-full flex mb-2 flex-wrap ">
              <div className="flex-1 mx-2 mb-2 min-w-[300px] space-y-2">
                  <label htmlFor="aadharDoc">Aadhar Card (Both Sides) *</label>
                  <input className="w-full border leading-8 rounded-3xl" type="file" onChange={handleFileChange} id="aadharDoc" name="aadharDoc" />
              ...
              <div className="flex-1 mx-2 mb-2 min-w-[300px] space-y-2">
                  ...
                  <button type='button' onClick={() => handleUpload('panDoc')} className="px-5 py-1 border rounded-3xl bg-blue-500 text-white">Upload</button>
          ...
          <div className="w-full flex mb-2 flex-wrap ">
              <div className="flex-1 mx-2 mb-2 min-w-[300px] space-y-2">
                  <label htmlFor="gstDoc">GST Certificate </label>
                  <input className="w-full border leading-8 rounded-3xl" type="file" onChange={handleFileChange} id="gstDoc" name="gstDoc" />
                  <button type='button' onClick={() => handleUpload('gstDoc')} className="px-5 py-1 border rounded-3xl bg-blue-500 text-white">Upload</button>
                  {uploadStatus.gstDoc && <span>✔️</span>}
              </div>
              <div className="flex-1 mx-2 mb-2 min-w-[300px] space-y-2">
                  <label htmlFor="chequeDoc">Cancelled Cheque *</label>
                  <input className="w-full border leading-8 rounded-3xl" type="file" onChange={handleFileChange} id="chequeDoc" name="chequeDoc" />
                  <button type='button' onClick={() => handleUpload('chequeDoc')} className="px-5 py-1 border rounded-3xl bg-blue-500 text-white">Upload</button>
          ...
          <div className="w-1/2 flex mb-2 flex-wrap ">
              <div className="flex-1 mx-2 mb-2 min-w-[300px] space-y-2">
                  ...
                  <input className="w-full border leading-8 rounded-3xl" type="file" onChange={handleFileChange} id="selfieDoc" name="selfieDoc" />
                  <button type='button' onClick={() => handleUpload('selfieDoc')} className="px-5 py-1 border rounded-3xl bg-blue-500 text-white">Upload</button>
...
const TextForm = ({ onNext }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="w-[1024px] flex flex-col bg-white pt-8 px-4">
            <div className="w-full flex mb-2 flex-wrap ">
            </div>
            <div className="w-full flex mb-2 flex-wrap ">
                <div className="flex-1 mx-2 mb-2 min-w-[300px] space-y-2">
            ...
            <div className="px-2 space-x-4 mb-4">
                <button type='submit' className="px-5 py-1 border rounded-3xl bg-blue-500 text-white">Next</button>
                <button onClick={(e) => { e.preventDefault(); setFormData(InitialState) }} className="px-5 py-1 border rounded-3xl bg-red-500 text-white">Clear</button>
            </div>
        </form>
    );
  ...
  return (
      <>
          ...
          <div className='w-full flex flex-col items-center pt-16'>
              <div className='w-full flex flex-col items-center p-8'>
                  <div className='text-center text-3xl font-medium'>Verify your details</div>
                  {step === 1 ? <TextForm onNext={handleNextStep} /> : <FileUploadForm />}
              </div>
          </div>
          <Footer />
      </>
