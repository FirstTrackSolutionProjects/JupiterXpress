// ShipRunway\src\pages\AdminTicketDetail.jsx (NEW FILE for Phase 3 Admin View)
    ...
    return (
        <div className="p-4 md:p-8 max-w-6xl mx-auto bg-gray-50 min-h-screen">
            ...
            <div className="bg-white rounded-lg shadow-xl p-6">
                <h1 className="text-3xl font-bold text-purple-700 mb-2">Admin View: Ticket #{ticket.ticket_id}</h1>
                        ...
                        messages.map((msg) => (
                            <div key={msg.message_id} className={`flex mb-4 ${msg.sent_by_admin ? 'justify-end' : 'justify-start'}`}>
                                <div className={`max-w-xl p-3 rounded-xl shadow-md 
                                    ${msg.sent_by_admin 
                                        ? 'bg-purple-700 bg-opacity-10 text-gray-800' 
                                        : 'bg-sky-600 bg-opacity-20 text-gray-900'}`
                                }>
