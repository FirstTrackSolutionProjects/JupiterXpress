  ...
  return (
    <>
      <div className="text-center text-3xl font-medium ">
        ...
        <form action="" className="flex flex-col space-y-3 sm:space-y-5 text-black mx-3">
...
const Login = ({authMode}) => {
  return (
    <div className={`absolute ${authMode?"flex":"hidden"} sm:py-8 z-20 inset-0 justify-center items-center`}>
      <div className={`relative justify-center space-y-10 py-5 flex flex-col items-center transition-all duration-500 w-[400px] h-[500px] sm:w-[600px] md:w-[760px] sm:h-[500px] md:h-[500px] lg:w-[700px] lg:h-[500px] rounded-xl bg-[rgba(135,206,235,0.3)]  ${authMode?"":"w-0"} `}>
