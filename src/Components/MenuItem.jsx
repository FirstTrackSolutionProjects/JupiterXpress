...
const MenuItem = ({icon, name, isDropdown, dropDownOptions, menuID ,setMenuID}) => {
    const [isOpen, setIsOpen] = useState(0)
  return (
    <>
    <div onClick={isDropdown?()=>setIsOpen(!isOpen):()=>setMenuID(menuID)} className=' cursor-pointer px-2 w-full h-12 bg-white transition-all duration-300 hover:bg-[rgba(37,168,229,0.6)] relative flex items-center border-r-2 border-b-2'>
