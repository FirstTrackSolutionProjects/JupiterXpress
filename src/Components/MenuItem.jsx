...
const MenuItem = ({icon, name, isDropdown, dropDownOptions}) => {
  ...
  return (
    <>
    <div onClick={()=>setIsOpen(!isOpen)} className=' cursor-pointer px-2 w-full h-12 bg-white hover:bg-[rgba(37,168,229,0.6)] relative flex items-center border-r-2 border-b-2'>
