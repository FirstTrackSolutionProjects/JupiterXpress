    ...
    return (
      <>
        ...
        <div className="w-full h-16 bg-white relative items-center px-4 sm:px-8 flex border-b">
          ...
          {!isShipped && <div className="px-3 py-1 bg-blue-500  rounded-3xl text-white cursor-pointer" onClick={isLoading?()=>{}:()=>alert("Website is under maintenance")}>{isLoading?"Shipping...":"Ship"}</div>}
          </div>
        </div>
