...
const CalcComp=()=>{
    return(
        <div className="bg-blue-100 font-inter">
            <div className="text-3xl px-2 bg-clip-text text-transparent bg-gradient-to-br from-blue-700  to-sky-400 text-center py-3 font-semibold">Estimate Your Shipping</div>
            <div className="md:grid md:grid-cols-2  ">
                ...
                <div className=" p-5">
                    ...
                    <div className="bg-blue-700 text-xs md:text-sm m-3 md:m-5 text-white p-2 flex w-fit md:w-44 items-center justify-center rounded-lg text-center"> Explore More <span><FaArrowRight className="h-3 w-4 md:h-4 md:w-5 ml-2"/></span></div>
                    <div className="">
